...
PROVIDER_CFGS = {
    ...
    "scalesweep_mse128": dict(
        backend="scalesweep_mse128", is_sf_swizzled_layout=False, enabled=True
    ),
    "scalesweep_mse128-swizzle": dict(
        backend="scalesweep_mse128", is_sf_swizzled_layout=True, enabled=True
    ),
