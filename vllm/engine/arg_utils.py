...
class EngineArgs:
    ...
    act_quant_backend: ActQuantBackend = KernelConfig.act_quant_backend
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        act_quant_backend_kwargs = kernel_kwargs["act_quant_backend"]
        act_quant_backend_kwargs["type"] = lambda s: s.lower().replace("-", "_")
        kernel_group.add_argument("--act-quant-backend", **act_quant_backend_kwargs)
    ...
    def create_engine_config(
        ...
        if self.act_quant_backend != "auto":
            kernel_config.act_quant_backend = self.act_quant_backend
